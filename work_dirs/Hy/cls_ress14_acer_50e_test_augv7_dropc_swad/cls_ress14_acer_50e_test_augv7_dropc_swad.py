...
data = dict(
    train=dict(
        ...
        pipeline=dict(
            ...
            RandomDropChannels=dict(num_channel=0.1, shuffle=False, p=0.1),
...
check_cfg = dict(
    ...
    save_topk=3,
    load_from=
    'work_dirs/Hy/cls_ress14_acer_50e_test_augv7_dropc_swad/latest.pth',
    resume_from=None,
    pretrain_from=None)
total_epochs = 50
freeze_cfg = None
work_dir = 'work_dirs/Hy/cls_ress14_acer_50e_test_augv7_dropc_swad'
gpu_ids = range(0, 1)
seed = 10
