...
class VisualizeLog(object):
    ...
    def _movingaverage(self, interval, window_size=25, mode='valid'):
...
if __name__ == '__main__':
    ...
    vis_log('/mnt/home/code/Face_AntiSpoofing/output/dcq_ress14_xty_v1_newcrop_zf/20221207_165706.log')
